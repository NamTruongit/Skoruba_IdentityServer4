...
using AuthServer.STS.Identity.Configuration;
using AuthServer.STS.Identity.Helpers;
using AuthServer.STS.Identity.ViewModels.Consent;
using AuthServer.STS.Identity.ViewModels.Device;

namespace AuthServer.STS.Identity.Controllers
{
    [Authorize]
    [SecurityHeaders]
